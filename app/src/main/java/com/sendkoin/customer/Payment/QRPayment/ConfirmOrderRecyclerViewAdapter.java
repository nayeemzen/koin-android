...
public class ConfirmOrderRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public ConfirmOrderRecyclerViewAdapter(Context context, ConfirmOrderFragment confirmOrderFragment) {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    switch (viewType) {
      case CONFIRM_ORDER_SALE_ITEM:
        View saleItemView = LayoutInflater.from(context).inflate(R.layout.inventory_item, parent, false);
        viewHolder = new SaleItemViewHolder(saleItemView);
        break;
      case CONFIRM_ORDER_MERCHANT_ITEM:
        View mercahtnItemView = LayoutInflater.from(context)
